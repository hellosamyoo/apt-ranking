...
date: 2019-01-02 06:27:15 +0900
last_modified_at: 2019-01-02 06:27:15 +0900
tags:
- 서울특별시 강남구
- 역삼동
...
|---|---|---|---|---|---|---|---|
|1|7.35%|[개나리4](https://search.naver.com/search.naver?query=%EC%84%9C%EC%9A%B8%ED%8A%B9%EB%B3%84%EC%8B%9C+%EA%B0%95%EB%82%A8%EA%B5%AC+%EC%97%AD%EC%82%BC%EB%8F%99+%EA%B0%9C%EB%82%98%EB%A6%AC4)|1979|160.33|349,800|1,821|201409|
...
new Chart(document.getElementById("deal_count_ranking"), {
    type: 'horizontalBar',
    data: {
        labels: ['대우디오빌', '한스빌(836)', '현대휴먼터치빌', '대우디오빌플러스', '갤러리하우스', '노블스위트', '네스빌(728-10)', '요진와이시티미니', '역삼자이', '테헤란아이파크', '(723-16)'],
        datasets: [{
            label: '실거래 수',
