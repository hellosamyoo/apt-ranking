...
new Chart(document.getElementById("deal_count_ranking"), {
    type: 'horizontalBar',
    data: {
        labels: ['세경', '주공5차', '한울', '금호타운1차', '신일해피트리', '삼성', '수송코아루', '롯데3차', '주공3차', '수송금호어울림', '유원', '우진', '현대2차', '현대4차', '우성', '금호2차', '청솔', '동신', '서호', '비사벌', '현대3차', '현대백조', '현대1차', '롯데4차', '나운동보람더하임', '롯데1차', '금호타운2차', '영창(3,5,6동)', '대우', '동신진주'],
        datasets: [{
            label: '실거래 수',
            data: [11, 9, 9, 8, 8, 8, 7, 6, 6, 6, 5, 5, 5, 5, 5, 5, 5, 4, 4, 4, 4, 4, 3, 3, 3, 2, 2, 2, 2, 2],
