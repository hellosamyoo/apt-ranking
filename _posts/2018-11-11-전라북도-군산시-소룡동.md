...
new Chart(document.getElementById("deal_count_ranking"), {
    type: 'horizontalBar',
    data: {
        labels: ['제이파크', '성원상떼빌', '그린서해맨션', '이화', '신흥무지개타운', '신도시시티빌', '동아', '나우하이츠', '금강골드빌', '진흥', '소룡그린', '삼성', '소망아트빌라'],
        datasets: [{
            label: '실거래 수',
            data: [8, 5, 4, 3, 3, 3, 2, 2, 2, 1, 1, 1, 1],
