...
new Chart(document.getElementById("deal_count_ranking"), {
    type: 'horizontalBar',
    data: {
        labels: ['행당동 행당한신', '금호동4가 대우', '옥수동 현대', '하왕십리동 왕십리자이', '마장동 현대', '응봉동 대림강변', '옥수동 극동', '옥수동 삼성', '송정동 건영', '성수동1가 갤러리아 포레', '금호동2가 래미안하이리버', '옥수동 이편한세상옥수파크힐스', '하왕십리동 금호베스트빌', '하왕십리동 청계벽산', '행당동 행당 한진타운', '응봉동 대림(2차)', '금호동3가 두산', '금호동4가 서울숲푸르지오', '송정동 서울숲아이파크', '옥수동 옥수파크힐스', '성수동1가 트리마제', '마장동 세림', '행당동 신동아', '성수동1가 LIG건영', '응봉동 대림(1차)', '마장동 마장동중앙하이츠', '성수동1가 서울숲한양현대', '하왕십리동 텐즈힐아파트(1단지)', '하왕십리동 극동미라주', '행당동 대림e-편한세상'],
        datasets: [{
            label: '실거래 수',
            data: [8, 6, 5, 5, 4, 4, 4, 4, 4, 4, 4, 4, 3, 3, 3, 3, 3, 3, 3, 3, 3, 2, 2, 2, 2, 2, 2, 2, 1, 1],
...
new Chart(document.getElementById("deal_progress"), {
    ...
    data: {
        ...
        datasets: [{
            label: '실거래 수',
            pointRadius: 1,
            data: [26, 97, 124, 138, 278, 222, 288, 264, 328, 267, 133, 115, 118, 168, 117, 124, 94, 64, 73, 62, 64, 80, 148, 179, 192, 282, 178, 172, 126, 115, 102, 173, 114, 138, 128, 89, 83, 76, 113, 117, 110, 77, 62, 47, 67, 85, 124, 126, 103, 97, 154, 227, 211, 217, 199, 113, 162, 216, 258, 154, 221, 261, 336, 309, 220, 153, 186, 234, 354, 381, 325, 260, 250, 336, 330, 647, 478, 383, 384, 383, 309, 327, 417, 251, 161, 161, 179, 308, 349, 371, 506, 508, 423, 379, 472, 212, 141, 133, 222, 323, 439, 663, 616, 616, 168, 229, 227, 384, 403, 613, 325, 249, 99, 107, 106, 179, 596, 289, 106, 27, 4],
