...
new Chart(document.getElementById("deal_count_ranking"), {
    type: 'horizontalBar',
    data: {
        labels: ['신성천안미소지움', '구성I-PARK', '향목그라비스', '구성휴먼시아'],
        datasets: [{
            label: '실거래 수',
            data: [2, 1, 1, 1],
