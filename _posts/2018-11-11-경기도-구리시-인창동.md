...
new Chart(document.getElementById("deal_count_ranking"), {
    type: 'horizontalBar',
    data: {
        labels: ['한진', '원일아름', '원일가대라곡', '주공2', '주공6', '아름마을삼성', '삼보', '더샵그린포레2단지', '인창2차e-편한세상', '성원', '아름마을성원', '동양주택조합', '주공4-2', '구리인창금호어울림', '더샵그린포레1단지', '아름마을엘지', '주공1', '삼호', '현대홈타운', '신일', '다우림', '주공4-1', '삼환', '동흥', '아름마을일신건영', '구리인창2차동문굿모닝힐', '건영', '동원베네스트', '충효', '대명(610-20)'],
        datasets: [{
            label: '실거래 수',
            data: [17, 14, 11, 9, 9, 8, 6, 6, 5, 4, 4, 4, 4, 4, 4, 3, 3, 3, 3, 3, 3, 2, 2, 2, 2, 2, 1, 1, 1, 1],
