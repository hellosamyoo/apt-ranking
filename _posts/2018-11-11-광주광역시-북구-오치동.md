...
new Chart(document.getElementById("deal_count_ranking"), {
    type: 'horizontalBar',
    data: {
        labels: ['주공', '우미', '삼익', '우성', '무등파크', '한국아델리움', '혁신타운', '금호타운', '공간', '럭키', '오치', '로얄타운', '양지', '오치동 갤럭스하임', '오치동 도나우', '대웅', '중도다이아빌', '대화아파트', '청암', '명진명가'],
        datasets: [{
            label: '실거래 수',
            data: [27, 6, 6, 5, 4, 4, 3, 3, 3, 3, 3, 2, 2, 2, 2, 1, 1, 1, 1, 1],
