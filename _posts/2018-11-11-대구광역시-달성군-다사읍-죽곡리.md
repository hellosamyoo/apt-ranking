...
new Chart(document.getElementById("deal_count_ranking"), {
    type: 'horizontalBar',
    data: {
        labels: ['죽곡 한신 휴 플러스', '강창하이츠', '강창태성그린시티', '죽곡청아람 리슈빌 3단지', '죽곡푸르지오2단지', '대실역이편한세상', '죽곡청아람리슈빌4단지', '강창훼미리타운'],
        datasets: [{
            label: '실거래 수',
            data: [13, 8, 4, 4, 4, 3, 3, 1],
...
new Chart(document.getElementById("deal_progress"), {
    ...
    data: {
        ...
        datasets: [{
            label: '실거래 수',
            pointRadius: 1,
            data: [5, 7, 16, 57, 13, 19, 20, 20, 25, 40, 22, 24, 17, 20, 24, 37, 24, 19, 17, 28, 28, 26, 32, 29, 27, 30, 30, 28, 32, 37, 29, 31, 29, 44, 25, 29, 29, 18, 25, 31, 21, 41, 32, 21, 22, 27, 39, 22, 17, 17, 22, 22, 38, 45, 123, 20, 29, 31, 35, 21, 86, 37, 48, 32, 27, 31, 30, 30, 38, 42, 33, 16, 10, 27, 29, 32, 37, 27, 30, 40, 30, 26, 34, 12, 11, 4, 6, 17, 15, 4, 15, 13, 15, 36, 31, 16, 16, 18, 21, 21, 23, 31, 44, 39, 46, 45, 29, 40, 51, 30, 31, 39, 23, 21, 27, 12, 25, 43, 31, 9, 0],
