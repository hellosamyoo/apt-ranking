...
date: 2018-12-17 07:03:40 +0900
last_modified_at: 2018-12-17 07:03:40 +0900
tags:
- 충청남도 아산시

---

* 마지막 업데이트 : 2018-12-17 07:03:40
...
|20|30.94%|[탕정면 명암리 탕정삼성트라팰리스](https://search.naver.com/search.naver?query=%EC%B6%A9%EC%B2%AD%EB%82%A8%EB%8F%84+%EC%95%84%EC%82%B0%EC%8B%9C+%ED%83%95%EC%A0%95%EB%A9%B4+%EB%AA%85%EC%95%94%EB%A6%AC+%ED%83%95%EC%A0%95%EC%82%BC%EC%84%B1%ED%8A%B8%EB%9D%BC%ED%8C%B0%EB%A6%AC%EC%8A%A4)|2009|127.5|40,000|928|201409|
...
new Chart(document.getElementById("deal_count_ranking"), {
    type: 'horizontalBar',
    data: {
        labels: ['배방읍 공수리 배방 삼정그린코아', '신창면 행목리 아산에스알친오애', '음봉면 산동리 삼일원앙', '배방읍 갈매리 배방자이', '장존동 청솔', '음봉면 덕지리 더샵레이크사이드', '배방읍 세교리 신라', '탕정면 명암리 탕정삼성트라팰리스', '신창면 행목리 아산 신창 양우내안애', '풍기동 동일하이빌(아)', '배방읍 장재리 요진 와이시티', '인주면 해암리 미진무지개', '둔포면 석곡리 아산테크노밸리 EG the1 3단지', '풍기동 주은', '좌부동 초원설화타운2', '신창면 읍내리 경희학성', '용화동 용화 아이파크', '배방읍 세교리 신한', '신창면 남성리 아산코아루에듀파크', '득산동 부영', '배방읍 공수리 아산한도', '좌부동 초원설화타운1', '권곡동 청솔', '온천동 힐스테이트', '배방읍 공수리 중앙하이츠오르젠1단지', '풍기동 현대아이파크(아)', '배방읍 장재리 장재마을휴먼시아11단지', '음봉면 동암리 아산 더샵 레이크시티3차', '용화동 용화주공3', '모종동 한성필하우스'],
        datasets: [{
            label: '실거래 수',
            data: [42, 17, 16, 15, 15, 14, 13, 12, 12, 11, 11, 11, 11, 10, 10, 10, 10, 9, 9, 9, 8, 8, 8, 7, 7, 7, 7, 7, 6, 6],
...
new Chart(document.getElementById("deal_progress"), {
    ...
    data: {
        ...
        datasets: [{
            label: '실거래 수',
            pointRadius: 1,
            data: [239, 192, 247, 273, 235, 265, 351, 310, 507, 415, 477, 344, 251, 310, 264, 341, 309, 263, 297, 281, 298, 295, 431, 369, 421, 404, 487, 611, 551, 552, 553, 461, 524, 517, 561, 547, 486, 382, 605, 597, 511, 480, 398, 326, 333, 391, 538, 486, 368, 275, 357, 476, 518, 460, 465, 284, 340, 359, 501, 403, 393, 437, 532, 567, 458, 408, 448, 413, 500, 551, 545, 368, 350, 476, 362, 542, 459, 398, 350, 349, 341, 380, 460, 367, 284, 243, 249, 304, 295, 291, 345, 301, 373, 320, 416, 296, 260, 229, 317, 322, 250, 330, 409, 365, 319, 342, 299, 306, 282, 293, 330, 418, 279, 278, 301, 226, 283, 293, 338, 207, 45],
