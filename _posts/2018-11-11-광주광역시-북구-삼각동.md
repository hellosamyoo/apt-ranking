...
new Chart(document.getElementById("deal_count_ranking"), {
    type: 'horizontalBar',
    data: {
        labels: ['삼각동그린타운', '일곡엘리체프라임', '삼각동서라', '모아호반', '삼각동 혁신타운', '삼익', '호반', '우미', '극동마이다스빌', '드림네스트삼각1차'],
        datasets: [{
            label: '실거래 수',
            data: [13, 11, 8, 7, 5, 4, 4, 2, 1, 1],
