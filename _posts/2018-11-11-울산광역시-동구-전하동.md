...
date: 2018-11-27 21:35:52 +0900
last_modified_at: 2018-11-27 21:35:52 +0900
tags:
- 울산광역시 동구
- 전하동
...
new Chart(document.getElementById("deal_count_ranking"), {
    type: 'horizontalBar',
    data: {
        labels: ['e편한세상전하', '울산전하푸르지오', '현대3', '대경넥스빌', '전하아이파크', '전하동현대홈타운', '현대패밀리전하', '삼전아이필하모니', '현대한마음', '삼전아이필101', '제일그린', '반석', '정우스위트파크'],
        datasets: [{
            label: '실거래 수',
            data: [7, 5, 2, 2, 2, 1, 1, 1, 1, 1, 1, 1, 1],
