...
date: 2018-11-27 21:32:00 +0900
last_modified_at: 2018-11-27 21:32:00 +0900
tags:
- 인천광역시 미추홀구
- 숭의동
...
new Chart(document.getElementById("deal_count_ranking"), {
    type: 'horizontalBar',
    data: {
        labels: ['리치하임2차', '한화꿈에그린', '솔라리움', '동아씨티월드', '프린스', '다우림', '한우리', '광해리드빌', '대호', '예성', '현대', '태양', '박문', '숭의맨숀', '한빛아파트1동2동', '(169-14)', '한양맨션', '신정', '금호파크빌', '신안래미안', '대준블루온 101동', '스타뷰', '옥크빌', '라임카운티A'],
        datasets: [{
            label: '실거래 수',
