...
new Chart(document.getElementById("deal_count_ranking"), {
    type: 'horizontalBar',
    data: {
        labels: ['가야주공', '세종', '우륵', '주몽2-10', '한양수리', '한라주공4-2', '개나리주공13', '매화', '주공11', '가야3주공', '한양목련', '설악2', '한라주공4', '산본2차이-편한세상', '금강2단지주상복합', '솔거대림', '우방,한국공영목련', '동백(우성)', '주공9단지금강', '덕유', '신안모란', '백두(동성)', '설악', '백합', '계룡', '래미안 하이어스', '주몽마을(대림)', '삼익가든을지', '한일을지', '한양백두'],
        datasets: [{
            label: '실거래 수',
            data: [18, 17, 15, 12, 11, 11, 10, 9, 8, 8, 8, 6, 6, 5, 4, 4, 4, 4, 4, 4, 3, 3, 3, 3, 3, 3, 2, 2, 2, 2],
