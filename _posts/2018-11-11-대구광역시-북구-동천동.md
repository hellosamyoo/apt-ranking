...
new Chart(document.getElementById("deal_count_ranking"), {
    type: 'horizontalBar',
    data: {
        labels: ['보성서한타운', '동화골든빌', '칠곡3화성타운', '부영그린타운(2단지)', '화성센트럴파크', '칠곡화성타운2차', '칠곡2영남타운', '칠곡네스빌', '칠곡우방하이츠', '영남네오빌아트'],
        datasets: [{
            label: '실거래 수',
            data: [16, 16, 15, 10, 10, 7, 5, 4, 3, 2],
