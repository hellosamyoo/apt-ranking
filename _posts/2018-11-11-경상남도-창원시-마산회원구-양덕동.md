...
new Chart(document.getElementById("deal_count_ranking"), {
    type: 'horizontalBar',
    data: {
        labels: ['드림타워', '메트로시티2단지', '한일타운2', '마산양덕4차한일타운', '한일3', '메트로시티', '우성', '한일타운', '정우맨션', '양덕코오롱하늘채', '송촌e'누리채 아파트', '대림하이빌', '서안타운', '거북', '한일사원', '무학', '타워맨션', '태양', '장미'],
        datasets: [{
            label: '실거래 수',
            data: [9, 6, 4, 4, 4, 4, 3, 2, 2, 2, 2, 1, 1, 1, 1, 1, 1, 1, 1],
