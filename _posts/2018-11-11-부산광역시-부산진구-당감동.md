...
date: 2018-11-27 21:28:17 +0900
last_modified_at: 2018-11-27 21:28:17 +0900
tags:
- 부산광역시 부산진구
- 당감동
...
new Chart(document.getElementById("deal_count_ranking"), {
    type: 'horizontalBar',
    data: {
        labels: ['개금주공3단지', '동일스위트', '태화현대1', '백양푸른채', '서면봄여름가을겨울', '국제백양', '당감주공1차,백양뜨란채', '무궁화아파트 101동, 102동, 103동, 105동, 106동', '국제프라자', '태화현대2', '삼익아파트', '무궁화(108-116동)', '무궁화(117-119동)', '개금주공3단지(518-0)', '금호그랜드타운', '동원', '홍림로즈빌', '파인트리', '골든엠파이어', '세원수아파트'],
        datasets: [{
            label: '실거래 수',
            data: [13, 7, 7, 6, 6, 4, 4, 4, 2, 2, 2, 2, 1, 1, 1, 1, 1, 1, 1, 1],
