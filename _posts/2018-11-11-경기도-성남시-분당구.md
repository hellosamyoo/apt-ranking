...
|24|12.24%|[분당동 장안타운(건영)](https://search.naver.com/search.naver?query=%EA%B2%BD%EA%B8%B0%EB%8F%84+%EC%84%B1%EB%82%A8%EC%8B%9C+%EB%B6%84%EB%8B%B9%EA%B5%AC+%EB%B6%84%EB%8B%B9%EB%8F%99+%EC%9E%A5%EC%95%88%ED%83%80%EC%9A%B4%28%EA%B1%B4%EC%98%81%29)|1993|131.55|195,000|551|200904|
...
new Chart(document.getElementById("deal_count_ranking"), {
    type: 'horizontalBar',
    data: {
        labels: ['정자동 한솔마을(4단지)(주공)', '야탑동 매화마을공무원2', '정자동 한솔마을(5단지)(주공)', '정자동 분당파크뷰', '정자동 현대I-PARK1', '서현동 시범한양', '구미동 무지개(12단지)(주공뜨란체)', '분당동 장안타운(건영)', '수내동 푸른마을(신성)', '구미동 무지개(2단지)(엘지)', '판교동 판교원마을7단지(모아미래도)임대', '정자동 정든마을(6단지)(우성)', '정자동 느티마을(4단지)(공무원)', '서현동 시범현대', '서현동 시범삼성', '야탑동 탑마을(선경)1', '금곡동 청솔마을(주공9단지)', '백현동 판교알파리움2단지', '수내동 양지마을(금호1)', '수내동 파크타운(삼익)', '수내동 파크타운(대림)', '정자동 한솔마을(1단지)(청구)', '정자동 정든마을(2단지)(동아)', '정자동 정든마을(7단지)(한진)', '정자동 상록마을(라이프1차)', '정자동 아데나팰리스', '정자동 상록마을(보성)', '정자동 로얄팰리스', '서현동 시범우성', '서현동 효자촌(현대)'],
        datasets: [{
            label: '실거래 수',
            data: [7, 7, 6, 6, 6, 6, 5, 4, 4, 4, 4, 3, 3, 3, 3, 3, 3, 3, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2],
