...
new Chart(document.getElementById("deal_count_ranking"), {
    type: 'horizontalBar',
    data: {
        labels: ['정자동 한솔마을(4단지)(주공)', '정자동 분당파크뷰', '야탑동 매화마을공무원2', '정자동 한솔마을(5단지)(주공)', '정자동 현대I-PARK1', '서현동 시범한양', '수내동 푸른마을(신성)', '구미동 무지개(12단지)(주공뜨란체)', '분당동 장안타운(건영)', '금곡동 청솔마을(주공9단지)', '구미동 무지개(2단지)(엘지)', '판교동 판교원마을7단지(모아미래도)임대', '정자동 정든마을(6단지)(우성)', '정자동 느티마을(4단지)(공무원)', '정자동 로얄팰리스', '서현동 시범현대', '서현동 시범삼성', '야탑동 장미마을(동부)', '야탑동 탑마을(선경)1', '구미동 하얀마을(5단지)(주공)', '야탑동 매화마을(주공4)', '백현동 판교알파리움2단지', '수내동 양지마을(금호1)', '수내동 파크타운(삼익)', '수내동 파크타운(대림)', '정자동 한솔마을(1단지)(청구)', '정자동 정든마을(2단지)(동아)', '정자동 정든마을(7단지)(한진)', '정자동 상록마을(라이프1차)', '정자동 아데나팰리스'],
        datasets: [{
            label: '실거래 수',
            data: [7, 7, 7, 6, 6, 6, 5, 5, 4, 4, 4, 4, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 2, 2, 2, 2, 2, 2, 2, 2],
