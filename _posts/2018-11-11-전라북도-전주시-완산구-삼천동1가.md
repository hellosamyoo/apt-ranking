...
new Chart(document.getElementById("deal_count_ranking"), {
    type: 'horizontalBar',
    data: {
        labels: ['삼천주공(3)', '흥건삼천2차', '(유)남양건설삼천동임대', '호반리젠시빌', '쌍용2', '신일', '신일강변', '쌍용(1)', '삼천주공4단지', '우성그린', '광진공작', '개나리(1)', '우성삼천2차', '흥건삼천1차', '오성대우', '광진궁전맨션', '삼천주공5단지', '세창짜임', '세경', '이안전주삼천', '삼천하이츠', '쌍용(3차)', '청솔금호타운', '광진목화', '개나리(2)', '안행현대', '대왕장미타운', '우성'],
        datasets: [{
            label: '실거래 수',
            data: [10, 8, 8, 7, 6, 6, 6, 5, 4, 4, 4, 4, 3, 3, 3, 3, 3, 3, 3, 3, 2, 2, 2, 2, 2, 1, 1, 1],
